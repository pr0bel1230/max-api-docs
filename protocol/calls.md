...
> **Примечание:** `registered-peer` задокументирован по данным из исходного кода
> (репозиторий icyfalc0n/maxcalls), но **не обнаружен** ни в одной из двух
> HAR-записей реальных звонков (76 + 57 signaling сообщений). Возможная
> причина: приходит только звонящему, а не принимающему, или был заменён
> на `media-settings-changed` в более новой версии протокола.
